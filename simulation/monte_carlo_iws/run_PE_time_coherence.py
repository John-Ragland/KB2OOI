...
if __name__ == '__main__':
    ...
    fnr = f'{os.environ['data_directory']}time_coherence_iws/{node}_{realization:02}_Gfz_real.nc'
    fni = f'{os.environ['data_directory']}time_coherence_iws/{node}_{realization:02}_Gfz_imag.nc'
